...
def test_init_creates_dbt_profile(runner, temp_dir):
    ...
    with runner.isolated_filesystem():
        ...
        try:
            ...
            assert f"path: {Path.cwd().absolute()}/{project_name}/data/{project_name}.duckdb" in content
...
def test_init_creates_valid_config(runner, temp_dir):
    ...
    with runner.isolated_filesystem():
        ...
        required_fields = ["project", "target", "duckdb_path", "pipelines_path", "dbt_path", "profiles_dir"]
