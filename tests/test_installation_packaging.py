    ...
    def test_virtual_environment_creation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = subprocess.run(
                [str(pip_exe), "--version"], capture_output=True, text=True
            )
...
class TestDistribution:
    ...
    def test_template_files_completeness(self):
        ...
        template_dirs = [
            "sbdk/templates/pipelines",
            "sbdk/templates/dbt",
            "sbdk/templates/fastapi_server",
        ]
    ...
    def test_cli_entry_point(self):
        ...
        assert main_py.exists(), "CLI main module should exist"
        ...
        with open(main_py) as f:
            ...
            assert first_line.startswith(
                "#!/usr/bin/env python"
            ), "CLI main module should have proper shebang"
...
class TestDeploymentScenarios:
    ...
    def test_module_execution(self):
        ...
        # Test running CLI module directly
        result = subprocess.run(
    ...
    def test_entry_point_execution(self):
        """Test that CLI entry point works (requires installation)"""
        # Test entry point defined in pyproject.toml
        ...
        try:
            ...
            # If installed, should work
            if result.returncode == 0:
                assert "SBDK.dev" in result.stdout
            else:
                pytest.skip("Package not installed for entry point testing")
        except FileNotFoundError:
            pytest.skip("SBDK CLI not available in PATH")
...
class TestUserInstallationExperience:
    ...
    def test_clean_install_simulation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            dirs_to_copy = ["sbdk", "cli", "pipelines", "dbt", "fastapi_server"]
