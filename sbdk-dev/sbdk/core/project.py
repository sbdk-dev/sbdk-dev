...
class SBDKProject:
    ...
    def __init__(self, config: Optional[SBDKConfig] = None, project_root: Optional[Path] = None):
    ...
    def run_dbt(self, command: str = "run", extra_args: Optional[List[str]] = None) -> bool:
        """Run dbt commands"""
